    ...
    const events = [
      ...
      },
      {
        ...
        Meta_Data: {
          ...
          details: 'Bi-weekly scouting will be completed. Organic insecticide will be applied to the South Field to manage aphids.',
          color: '#dc3545',
          name: 'Pest Control',
      ...
      },
      {
        ...
        Meta_Data: {
          ...
          details: 'The first batch of wheat will be harvested. The yield is expected to be above average.',
          color: '#ffc107',
          name: 'Harvesting',
          yield: '3.5 tons',
          weather: 'Sunny',
